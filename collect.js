 ...
 */
const FOREST = [
  ["(가평군)강씨봉자연휴양림", "ID02030019"],
  ["(가평군)유명산자연휴양림", "0101"],
  ["(가평군)청평자연휴양림", "ID04030007"],
  ["(가평군)칼봉산자연휴양림", "ID02030099"],
  ["(강릉시)대관령자연휴양림", "0111"],
  ["(강릉시)임해자연휴양림", "ID02030100"],
  ["(강화군)강화자연휴양림", "ID04030105"],
  ["(강화군)석모도자연휴양림", "ID02030071"],
  ["(고성군)진부령자연휴양림", "0306"],
  ["(공주시)공주산림휴양마을", "ID02030011"],
  ["(괴산군)성불산자연휴양림", "ID02030070"],
  ["(괴산군)조령산자연휴양림", "ID02030008"],
  ["(금산군)금산산림문화타운", "ID02030063"],
  ["(금산군)금산자연휴양림", "0305"],
  ["(남양주시)축령산자연휴양림", "ID02030050"],
  ["(노원구)수락산동막골자연휴양림", "ID02030129"],
  ["(논산시)양촌자연휴양림", "ID02030034"],
  ["(단양군)소백산자연휴양림", "ID02030009"],
  ["(단양군)소선암자연휴양림", "ID02030041"],
  ["(단양군)황정산자연휴양림", "0242"],
  ["(대전시)만인산자연휴양림", "ID02030111"],
  ["(대전시)장태산자연휴양림", "ID02030106"],
  ["(동두천시)동두천자연휴양림", "ID02030023"],
  ["(보령시)성주산자연휴양림", "ID02030078"],
  ["(보령시)오서산자연휴양림", "0191"],
  ["(보령시)원산도자연휴양림", "ID02030130"],
  ["(보은군)속리산말티재자연휴양림", "0115"],
  ["(보은군)속리산숲체험휴양마을", "ID02030035"],
  ["(보은군)충북알프스자연휴양림", "ID02030032"],
  ["(부여군)만수산자연휴양림", "ID02030007"],
  ["(삼척시)검봉산자연휴양림", "0244"],
  ["(삼척시)삼척활기자연휴양림", "ID02030104"],
  ["(서산시)용현자연휴양림", "0220"],
  ["(서천군)희리산자연휴양림", "0187"],
  ["(아산시)영인산자연휴양림", "ID02030012"],
  ["(안성시)서운산자연휴양림", "ID02030092"],
  ["(양구군)광치자연휴양림", "ID02030095"],
  ["(양양군)미천골자연휴양림", "0112"],
  ["(양양군)송이밸리자연휴양림", "ID02030049"],
  ["(양주시)신암저수지숲속야영장", "ID02030123"],
  ["(양주시)아세안자연휴양림", "0104"],
  ["(양평군)산음자연휴양림", "0103"],
  ["(양평군)양평 백운봉 자연휴양림", "ID02030087"],
  ["(양평군)양평설매재자연휴양림", "ID04030004"],
  ["(양평군)양평쉬자파크", "ID02030079"],
  ["(양평군)중미산자연휴양림", "0108"],
  ["(연천군)고대산자연휴양림", "ID02030001"],
  ["(영동군)민주지산자연휴양림", "ID02030107"],
  ["(영월군)망경대산자연휴양림", "ID02030067"],
  ["(예산군)봉수산자연휴양림", "ID02030028"],
  ["(옥천군)장령산자연휴양림", "ID02030036"],
  ["(옹진군)덕적도자연휴양림", "ID02030127"],
  ["(용인시)용인자연휴양림", "ID02030031"],
  ["(원주시)백운산자연휴양림", "0223"],
  ["(원주시)치악산자연휴양림", "ID02030024"],
  ["(원주시)피노키오자연휴양림", "ID04030001"],
  ["(음성군)백야자연휴양림", "ID02030016"],
  ["(음성군)수레의산자연휴양림", "ID02030017"],
  ["(의왕시)의왕바라산자연휴양림", "ID02030065"],
  ["(인제군)갯골자연휴양림", "ID02030120"],
  ["(인제군)방태산자연휴양림", "0109"],
  ["(인제군)용대자연휴양림", "0102"],
  ["(인제군)하추자연휴양림", "ID02030018"],
  ["(인천시)무의도자연휴양림", "0303"],
  ["(정선군)가리왕산자연휴양림", "0113"],
  ["(제천시)박달재자연휴양림", "ID02030062"],
  ["(제천시)옥전자연휴양림", "ID02030110"],
  ["(증평군)좌구산휴양랜드", "ID02030089"],
  ["(진천군)생거진천자연휴양림", "ID02030033"],
  ["(천안시)태학산자연휴양림", "ID02030040"],
  ["(철원군)복주산자연휴양림", "0110"],
  ["(철원군)철원두루웰숲속문화촌", "ID02030005"],
  ["(청양군)칠갑산자연휴양림", "ID02030044"],
  ["(청주시)미원별빛자연휴양림", "ID02030132"],
  ["(청주시)상당산성자연휴양림", "0300"],
  ["(청주시)옥화자연휴양림", "ID02030054"],
  ["(춘천시)강원숲체험장", "ID02030096"],
  ["(춘천시)용화산자연휴양림", "0222"],
  ["(춘천시)집다리골자연휴양림", "ID02030043"],
  ["(춘천시)춘천숲자연휴양림", "ID02030125"],
  ["(충주시)계명산자연휴양림", "ID02030042"],
  ["(충주시)문성자연휴양림", "ID02030055"],
  ["(충주시)봉황자연휴양림", "ID02030051"],
  ["(태백시)태백고원자연휴양림", "ID02030022"],
  ["(태안군)안면도자연휴양림", "ID02030086"],
  ["(평창군)두타산자연휴양림", "0243"],
  ["(평창군)평창자연휴양림", "ID02030003"],
  ["(포천시)운악산자연휴양림", "0224"],
  ["(포천시)천보산자연휴양림", "CBMNT"],
  ["(홍성군)용봉산자연휴양림", "ID02030080"],
  ["(홍천군)가리산자연휴양림", "ID02030002"],
  ["(홍천군)삼봉자연휴양림", "0107"],
  ["(화성시)무봉산 자연휴양림", "ID02030118"],
  ["(화천군)화천숲속야영장", "0116"],
  ["(횡성군)청태산자연휴양림", "0106"],
  ["(횡성군)횡성자연휴양림", "ID04030002"],
];
