...
export const PACE = {
  ...
  suspense: 1000,       // 답을 고른 뒤 팝업이 뜨기 전 뜸
  cardFlip: 420,         // 짝 맞추기 카드 뒤집히는 효과 (600에서 30% 빠르게, 사용자 요청)
  matchFlipBack: 3000,   // 틀린 카드 두 장이 다시 덮이기까지
  matchPreview: 3000,    // 짝 맞추기: 시작할 때 카드를 앞면으로 보여주는 시간
  memoryLead: 1000,      // 순서 기억하기: 시작 누른 뒤 첫 불까지
  memoryOn: 1500,        // 한 칸에 불이 켜져 있는 시간
  memoryGap: 700,        // 불과 불 사이 쉬는 시간
  tapWrong: 700,         // 숫자 누르기·그림 찾기: 틀린 칸 빨간 표시가 남아 있는 시간
  roundDone: 800,        // 숫자 누르기·그림 찾기: 판을 다 마친 뒤 결과 팝업까지
  numberLimit: 10000,    // 숫자 누르기 2판째: 시간 제한
  stamp: 1500,           // 도장 "쿵" 효과
};
